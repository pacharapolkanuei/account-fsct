  ...
  console.log( "ready!" );
    ...
    $.get('getmaterial', function(res) {
      ...
      $(add_button).click(function(e){
          ...
          if(x < max_fields){
              x++;
              $(wrapper2).append('<tr><td><select name="name_material[]" class="form-control"  required>'+option+'</select></td><td><input class="form-control mb-2 mr-sm-2" type="text" pattern="[0-9.]*" name="produce[]" onblur="findTotal()" ></td><td><input class="form-control mb-2 mr-sm-2" type="text" pattern="[0-9.]*" name="material_cost[]" onblur="findTotal()" /></td><td><input class="form-control mb-2 mr-sm-2" type="text" pattern="[0-9.]*" name="total_cost[]" onblur="findTotal()" /></td><td><input class="form-control mb-2 mr-sm-2" type="text" pattern="[0-9.]*" name="salary[]" onblur="findTotal()" /></td><td><input class="form-control mb-2 mr-sm-2" type="text" pattern="[0-9.]*" name="cost_forproduce[]" onblur="findTotal()" /></td><td><input class="form-control mb-2 mr-sm-2" type="text" pattern="[0-9.]*" name="produce_unit[]" onblur="findTotal()" /></td><td style="text-align: center;"> <input type="hidden" onchange="count(this)" id="eieiza1" value="'+(x-1)+'"> <a href="#" class="btn btn-danger delete"> ลบ</a></td></tr>');
              no = no+1;
          }
          else
          {
