...
<div class="content-page">
  ...
  <div class="content">
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachfinancial_statement_day" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printfinancial_statement_day?branch_id=<?php echo $branch_id;?>&&reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
