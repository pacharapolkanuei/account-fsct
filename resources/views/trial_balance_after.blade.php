...
<div class="content-page">
  ...
  <div class="content">
					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item active">งบทดลองหลังปิดบัญชี (รายสาขา)</li>
													</ol>
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachtrial_balance_after" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printtrial_balance_after?branch_id=<?php echo $branch_id;?>&&reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
          ...
          if(isset($query)){
            ...
            <table id="example" class="table table-striped table-bordered fontslabel" style="width:100%">
               ...
               <tr>
                  ...
                  <?php
                  $valuereturn = $value->acc_code." ".$branch_id;
                  $modelaccount_name = Maincenter::getdataaccount_name_after($valuereturn,$datepicker); //กรณี ไม่เอาหมวด 1 2 3
                  $modelaccount_name_select = Maincenter::getdataaccount_name_after_select($valuereturn,$datepicker); //กรณี ข้อมูลของหมวดที่ 1 2 3
                  $modelbroughtforward = Maincenter::getdatabroughtforward_branch($valuereturn,$datepicker); //กรณี มียอดยกมา
                  // if($modelaccount_name_select){
                  //       // echo "debit";
                  //       echo $modelaccount_name_select[0]->sumdebit; exit;
                  // }
                  ?>
