...
<div class="content-page">
  ...
  <div class="content">
					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item active">งบกำไรขาดทุน (ทั้งหมด)</li>
													</ol>
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachprofitloss_statement_allday" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printprofitloss_statement_allday?reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
    ...
    //-----------------------------------รวม----------------------------------------
                   ...
                   <tr>
                     <td><b><?php echo "รายได้"?></b>
                      <?php echo "<br>";
                                  echo "&nbsp;&nbsp;รายได้จากการขายหรือการให้บริการ"; ?> <a href="<?php echo url("/income_sell_detail?datepicker=$datepicker&&value=1");?>" target="_blank"><img src="images/global/view.png" ></a> <?php
                            echo "<br>";
                                  echo "&nbsp;&nbsp;รายได้อื่น"; ?> <a href="<?php echo url("/income_other_detail?datepicker=$datepicker");?>" target="_blank"><img src="images/global/view.png" ></a> <?php
                            echo "<b>";
                            echo "<br>";
                                  echo "&nbsp;&nbsp;รวมรายได้";
                      ?>
                   ...
                   <tr>
                     <td><b><?php echo "ค่าใช้จ่าย"?></b>
                      <?php echo "<br>";
                                  ...
                                  <!-- <a href="<?php //echo url("/cost_of_sales_detail?datepicker=$datepicker");?>" target="_blank"><img src="images/global/view.png" ></a>  -->
                                  <?php
                            echo "<br>";
                                  echo "&nbsp;&nbsp;ค่าใช้จ่ายในการขาย"; ?>
                                  <!-- <a href="<?php //echo url("/expenses_sales_detail?datepicker=$datepicker");?>" target="_blank"><img src="images/global/view.png" ></a>  -->
                                  <?php
                            echo "<br>";
                                  echo "&nbsp;&nbsp;ค่าใช้จ่ายในการบริหาร"; ?>
                                  <!-- <a href="<?php //echo url("/expenses_manage_detail?datepicker=$datepicker");?>" target="_blank"><img src="images/global/view.png" ></a>  -->
                                  <?php
                            echo "<b>";
                            echo "<br>";
                                  echo "&nbsp;&nbsp;รวมค่าใช้จ่าย";
