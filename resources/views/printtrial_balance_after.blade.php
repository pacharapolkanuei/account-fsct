                  ...
                  <div class="box box-primary">
                      <div class="breadcrumbs" id="breadcrumbs">
                          <ul class="breadcrumb">
                              ...
                              <table width="100%">
                                <tr>
                                  <td align="center" ><b>บริษัท ฟ้าใสคอนสตรัคชั่นทูลส์ จำกัด (<?php if($modelname){ echo $modelname[0]->name_branch;}?>) </b></td>
                                </tr>
              ...
              <table class="table table-bordered" width="100%" border="1" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><?php echo ($value->acc_code);?></td><!--Account code-->
                     ...
                     // $modelaccount_name = Maincenter::getdataaccount_name_after($valuereturn,$data['reservation']);
                     // $modelbroughtforward = Maincenter::getdatabroughtforward_branch($valuereturn,$data['reservation']);

                     $valuereturn = $value->acc_code." ".$branch_id;
                     $modelaccount_name = Maincenter::getdataaccount_name_after($valuereturn,$data['reservation']); //กรณี ไม่เอาหมวด 1 2 3
                     $modelaccount_name_select = Maincenter::getdataaccount_name_after_select($valuereturn,$data['reservation']); //กรณี ข้อมูลของหมวดที่ 1 2 3
                     $modelbroughtforward = Maincenter::getdatabroughtforward_branch($valuereturn,$data['reservation']); //กรณี มียอดยกมา
