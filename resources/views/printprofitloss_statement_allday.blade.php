    ...
    <section class="content">
       ...
       //-----------------------------------รวม----------------------------------------
                      ...
                      <tr>
                        ...
                        <td align="right">
                        <?php echo "<br>";
                                    echo number_format ($totalcost_of_sales + $totalcost_of_sales,2);
                              echo "<br>";
                              ...
                              echo "<b>";
                              echo "<br>";
                                    echo number_format (($totalcost_of_sales + $totalcost_of_sales) + $totalexpenses_sales + $totalexpenses_manage,2);
                        ?>
                        </td>
                      </tr>
