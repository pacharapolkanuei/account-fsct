                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="hidden" class="form-control" value="<?php echo Session::get('brcode');?>" name="branch">
                        </div>
                        <div class="col ">
                    ...
                    <div class="row">
                        ...
                        <div class="col ">
                            ...
                            <input type="text" class="form-control" placeholder="กรอกสาขาธนาคาร" name="branch_bank">
                        </div>
                    </div>
