                            ...
                            <fonts id="fontsheader">รายการทรัพย์สิน</fonts>
                               ...
                               ?>
                                ...
                                $baseAc1 = $connect1['fsctaccount'];
                                      $sql1 = "SELECT $baseAc1.po_detail.*,
                                                      $baseAc1.po_head.branch_id,
                                                      $baseAc1.accounttype.accounttypeno,
                                                      $baseAc1.good.status_toolasset
                                              FROM $baseAc1.po_detail
                                              ...
                                              WHERE $baseAc1.po_detail.po_headid = '$idpo'
                                              AND  $baseAc1.po_detail.status = '1'
                                              AND  $baseAc1.accounttype.statuasset = '1' ";
                                ...
                                <div>
                                    {!! Form::open(['route' => 'asset_list.store', 'method' => 'post' , 'id' => 'myForm' ,  'files' => true ]) !!}
                                        ...
                                        <fieldset class="border p-2">
                                          <legend id="fontscontent2" class="w-auto">&nbsp; สินทรัพย์รายการที่ <?php echo $a+1;;?>&nbsp;</legend>
                                                        <div class="form-inline">
                                                          <label id="fontslabel"><b>เลือกประเภทสินทรัพย์ : </b></label>
                                                          <div class="col-sm">
                                                            <input type="index" class="form-control" disabled value="<?php if($b->status_toolasset==0){ echo "สำนักงาน"; }else{ echo "สินค้าให้เช่า";} ?>">
                                                          </div>
                                                          <input type="hidden" name="assetlist_different[]" value="<?php echo $b->status_toolasset;?>">
                                                        ...
                                                        <fieldset class="border p-2">
                                                          <legend id="fontscontent2" class="w-auto">&nbsp; รายละเอียด &nbsp;</legend>
                                                           ...
                                                           <div class="form-inline">
                                                             <?php
                                                                  $accounttypeno = $b->accounttypeno;
                                                                  $sql2 = "SELECT $baseAc1.typeassetrefaccnub.*,
                                                                                  $baseAc1.typeasset.*,
                                                                                  $baseAc1.typeasset.id as typeassetid
                                                                          FROM $baseAc1.typeassetrefaccnub
                                                                          INNER JOIN $baseAc1.typeasset
                                                                            ON $baseAc1.typeassetrefaccnub.typeasset_id = $baseAc1.typeasset.id
                                                                          WHERE $baseAc1.typeassetrefaccnub.numberaccount = '$accounttypeno'
                                                                          AND  $baseAc1.typeassetrefaccnub.status = '1'
                                                                          AND  $baseAc1.typeasset.status = '1' ";
                                                                    $getdataResulte = DB::select($sql2);
                                                                  // print_r($getdataResulte);


                                                             ?>
                                                             <label id="fontslabel"><b>หมวด :</b></label>
                                                             <div class="col-sm">
                                                               <input type="hidden" name="groups[]" value="<?php echo $getdataResulte[0]->typeassetid; ?>">
                                                               <input type="index" style="width: 100%;max-width: 400px;" class="form-control" readonly value="<?php echo $getdataResulte[0]->name_typeasset; ?>" >
                                                             </div>
                                                             ...
                                                             <div class="col-sm">
                                                               <?php
                                                                       $accounttypeno = $b->accounttypeno;
                                                                       $sql3 = "SELECT $baseAc1.accounttype.*
                                                                               FROM $baseAc1.accounttype
                                                                               WHERE $baseAc1.accounttype.accounttypeno = '$accounttypeno'
                                                                               AND $baseAc1.accounttype.status = '1' ";
                                                                        $accounttypeResulte = DB::select($sql3);

                                                               ?>
                                                               <input type="hidden" name="groups_acc[]" value="<?php echo $accounttypeResulte[0]->id; ?>">
                                                               <input type="index" style="width: 100%;max-width: 400px;" class="form-control" readonly value="<?php echo $accounttypeResulte[0]->accounttypeno.'-'.$accounttypeResulte[0]->accounttypefull; ?>" >
                                                             </div>
                                                           </div>
                                                           ...
                                                           <div class="form-inline">
                                                             ...
                                                             <div class="col-sm">
                                                               <input style="width: 100%;max-width: 400px;" type="text" readonly name="ins_branch[]" class="form-control" value="<?php echo $b->branch_id; ?>" required>
                                                             </div>
                                                           </div>
                                                             ...
                                                             <table border="0">
                                                               <thead>
                                                                 ...
                                                                 <tr>
                                                                   ...
                                                                   <th><input type="date" autocomplete="off" class="form-control" readonly name="date_startuse[]"  value="<?php echo date('Y-m-d');?>"  ></th>
                                                                   <th><label class="col-form-label" id="fontslabel"><b>วันที่เริ่มใช้งาน&nbsp;</b></label></th>
                                                                   <th><input type="date" autocomplete="off" class="form-control" readonly name="date_buy[]"  value="<?php echo date('Y-m-d');?>" onchange="get_date()"></th>
                                                                 </tr>
                                                                 <tr>
                                                                   <th><label class="col-form-label" id="fontslabel"><b>ราคาทุน&nbsp;</b></label></th>
                                                                   <th><input type="text" name="price_buy[]" value="<?php echo $b->price*$b->amount; ?>" class="form-control" id="price_buyz" onchange="calculate_depreciation()" required readonly></th>
                                                                   <th>&nbsp;&nbsp;<label class="col-form-label" id="fontslabel"><b>อายุการใช้งาน&nbsp;</b></label></th>
                                                                   <th><input type="text" name="life_for_use[]" class="form-control"  value="<?php echo $getdataResulte[0]->percent_depreciation_expense; ?>" maxlength="1" id="life_for_usez" onchange="calculate_depreciation()" readonly></th>
                                                                 ...
                                                                 <tr>
                                                                   ...
                                                                   <th><input type="text" name="end_price_sell[]" class="form-control" value="<?php echo $b->amount; ?>" id="end_price_sellz"  readonly value="1"></th>
                                                                   <th>&nbsp;&nbsp;<label class="col-form-label" id="fontslabel"><b>อัตรา(%)&nbsp;</b></label></th>
                                                                   <th><input type="text" name="end_price_sellpercent[]" class="form-control" value="<?php echo 100/$getdataResulte[0]->percent_depreciation_expense; ?>"   id="end_price_sellpercentz" onchange="calculate_depreciation()" readonly></th>
                                                                 </tr>
                                                             ...
                                                             <table>
                                                               <thead>
                                                                 <tr>
                                                                   ...
                                                                   <th><input type="text" name="month_depreciation" class="form-control" id="month_depreciation" value="0" readonly></th>
                                                                   <th></th>
                                                                   <th></th>
                                                                 </tr>
                                                               </thead>
                                                        ...
                                                        <div class="form-inline">
                                                          ...
                                                          <div class="col-sm">
                                                            <input style="width: 100%;max-width: 1200px;" type="text" name="name_thai[]" value="<?php echo $b->list; ?>" id="name_thai" class="form-control" readonly>
                                                          </div>

                                                          <label id="fontslabel"><b>ชื่อรายการทรัพย์สิน (ภาษาอังกฤษ) :</b></label>
                                                          <div class="col-sm">
                                                            <input style="width: 100%;max-width: 1200px;" type="text" name="name_eng[]" value="<?php echo $b->list; ?>" id="name_eng" class="form-control" readonly>
                                                          </div>
                                                        </div>
                                                        </fieldset>
                                                        <br>
                                                             ...
                                                             <table border="0">
                                                               <thead>
                                                                 <tr>
                                                                   ...
                                                                   <th><input type="text" class="form-control" id="depreciation_buyz" name="depreciation_buyz" value="0.00" readonly onchange="depreciation()"></th>
                                                                   <th>&nbsp;&nbsp;<label class="col-form-label" id="fontslabel" ><b>ค่าเสื่อมเบื้องต้น&nbsp;</b></label></th>
                                                                   <th><input type="text" name="primary_depreciation"  id="primary_depreciation"  value="0.00" readonly class="form-control"></th>
                                                                 </tr>
