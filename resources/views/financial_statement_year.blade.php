...
<div class="content-page">
  ...
  <div class="content">
					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item active">งบแสดงฐานะการเงิน (รายสาขา)</li>
													</ol>
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachfinancial_statement_year" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printfinancial_statement_year?branch_id=<?php echo $branch_id;?>&&reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
