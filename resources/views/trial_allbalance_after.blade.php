...
<div class="content-page">
  ...
  <div class="content">
					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item">งบทดลองหลังปิดบัญชี</li>
													<li class="breadcrumb-item active">งบทดลองหลังปิดบัญชี (ทั้งหมด)</li>
													</ol>
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachtrial_allbalance_after" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printtrial_allbalance_after?reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
            ...
            <table id="example" class="table table-striped table-bordered fontslabel" style="width:100%">
               ...
               <tr>
                 ...
                 <td><?php echo ($value->acc_code);?></td><!--Account code-->
                  ...
                  <?php
                  $modelaccount_name = Maincenter::getdataaccount_name_all_after($value->acc_code,$datepicker); //กรณี ไม่เอาหมวด 1 2 3
                  $modelaccount_name_select = Maincenter::getdataaccount_name_all_after_select($value->acc_code,$datepicker); //กรณี ข้อมูลของหมวดที่ 1 2 3
                  $modelbroughtforward = Maincenter::getdatabroughtforward($value->acc_code,$datepicker); //กรณี มียอดยกมา
                  ...
                  <td align="center">
                    <a href="<?php echo url("/trial_balance_detail_after?idacc=$value->acc_code&&datepicker=$datepicker");?>" target="_blank"><img src="images/global/qt.png" ></a>
                  </td>
