...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm" style="">
          ...
          <label style=""><b>Date/วันที่ :<b> {{$report_paysers[0]->datebill}}</label>
          <label style="float:right"><b>AP NO/เลขที่ใบสำคัญจ่าย :<b> {{$report_paysers[0]->payser_number}}</label>
        <br>
          <label style=""><b>Receiver/ผู้รับเงิน :<b> {{$report_paysers[0]->pre}} {{$report_paysers[0]->name_supplier}}</label>
          <label style="float:right"><b>เลขที่ผู้เสียภาษี :<b> {{$report_paysers[0]->tax_id}}</label>
        <br>
          <label style="float:left"><b>Addeess/ที่อยู่ :<b> {{$report_paysers[0]->address}} ตำบล {{$report_paysers[0]->district}} อำเภอ {{$report_paysers[0]->amphur}} จังหวัด {{$report_paysers[0]->province}} รหัสไปรษณีย์  {{$report_paysers[0]->zipcode}} โทรศัพท์  {{$report_paysers[0]->phone}}</label>
        <br>
        <br>
