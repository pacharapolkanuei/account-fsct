...
<div class="content-page">
  ...
  <div class="content">
					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item active">แยกประเภทบัญชี (รายสาขา)</li>
													</ol>
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachledger_branch" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
         <div class="row">
          ...
          <div class="row">
              ...
              <!-- <div class="col-md-2">
                  <input type="text" name="reservation" id="reservation" value="<?php //if(isset($query)){ print_r($datepicker); }else{ echo date('d/m/Y');}?>" class="form-control datepicker" required readonly>
              </div> -->
              <div class="col-md-2">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printledger_branch?branch_id=<?php echo $branch_id;?>&&reservation=<?php echo $datepicker;?>&&acc_code=<?php echo $accontcode;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
            ...
            <table id="example" class="table table-striped table-bordered fontslabel" style="width:100%">
               ...
               <tr>
                 ...
                 <td align="right"><b> <!--Debit-->
                   <?php
                     $valuereturn = $accontcode." ".$branch_id;
