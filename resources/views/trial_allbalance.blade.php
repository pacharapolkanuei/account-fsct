...
<div class="content-page">
  ...
  <div class="content">
					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item active">งบทดลอง (ทั้งหมด)</li>
													</ol>
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachtrial_allbalance" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printtrial_allbalance?reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
          ...
          if(isset($query)){
            ...
            <table id="example" class="table table-striped table-bordered fontslabel" style="width:100%">
               ...
               <?php
                 ...
                 //     echo number_format($modelaccount_name[0]->sumdebit,2);
                 //     echo number_format($modelaccount_name[0]->sumcredit,2);
                 // }
               ...
               <tr>
                  ...
                  <td align="right"><!--Debit-->
                    ...
                    if($modelbroughtforward){
                      ...
                      }else if(($modelbroughtforward[0]->sumdebit) > ($modelbroughtforward[0]->sumcredit)){
                  ...
                  <td align="center">
                    <a href="<?php echo url("/trial_balance_detail?idacc=$value->accounttypeno&&datepicker=$datepicker");?>" target="_blank"><img src="images/global/qt.png" ></a>
                  </td>
