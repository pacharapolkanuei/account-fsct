					   ...
					   <div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder" id="fontscontent">
													...
													<li class="breadcrumb-item active">รายงานเจ้าหนี้การค้า (ค้างจ่าย)</li>
													</ol>
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="excelreportaccrued?branch_id=<?php echo $branch_id ;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
