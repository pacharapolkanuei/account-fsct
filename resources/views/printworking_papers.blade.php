              ...
              <table class="table table-bordered" width="100%" border="1" cellspacing="0">
                  ...
                  foreach ($datatresult as $key => $value) { ?>
                    ...
                    <?php
                        ...
                        $modeltatrial_budget_before = Maincenter::getdatatrial_budget_before($valuereturn,$data['reservation']);
                        $modeltatrial_budget_after = Maincenter::getdatatrial_budget_after($valuereturn,$data['reservation']);
                        $modelaccount_name = Maincenter::getdataaccount_name($valuereturn,$data['reservation']);
                        $modelaincome = Maincenter::getdataincome($valuereturn,$data['reservation']);
                        $modelafinancial = Maincenter::getdatafinancial($valuereturn,$data['reservation']);
