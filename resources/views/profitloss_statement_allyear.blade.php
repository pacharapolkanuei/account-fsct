...
<div class="content-page">
  ...
  <div class="content">
      ...
      <!-- <div class="box-body" style="overflow-x:auto;"> -->
        <form action="serachprofitloss_statement_allyear" method="post">
        ...
        <div class="col-md-6">
          <?php   if(isset($query)){ //echo $branch_id; ?>
            ...
            <?php //$path = '&branch_id='.$branch_id?>
                    ...
                    <a href="printprofitloss_statement_allyear?reservation=<?php echo $datepicker;?>" target="_blank" ><img src="images/global/printall.png"></a>
            <?php //} ?>
